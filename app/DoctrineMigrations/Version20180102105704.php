 ...
 */
class Version20180102105704 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE result ADD CONSTRAINT FK_136AC113E5C617D0 FOREIGN KEY (home_team) REFERENCES team (id) ON DELETE CASCADE');
